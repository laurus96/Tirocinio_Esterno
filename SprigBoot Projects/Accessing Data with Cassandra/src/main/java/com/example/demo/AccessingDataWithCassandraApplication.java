...
import com.example.demo.veterinarian.Vet;
import com.example.demo.veterinarian.VetRepository;
...
public class AccessingDataWithCassandraApplication {

	public static void main(String[] args) {
		SpringApplication.run(AccessingDataWithCassandraApplication.class, args);
	}

	private final static Logger log = LoggerFactory.getLogger(AccessingDataWithCassandraApplication.class);
